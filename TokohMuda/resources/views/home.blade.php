...
<body class="body">
	<div class="navbar-logo-left wf-section">
		<div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" role="banner" class="navbar-logo-left-container shadow-three w-nav">
			<div class="container">
				<div class="navbar-wrapper">
					<a href="#" class="navbar-brand w-nav-brand"><img src="assets/Logo_Tokoh_Muda.jpg" loading="lazy" height="80" srcset="" alt="logo" class="image-4"></a>
					<nav role="navigation" class="nav-menu-wrapper w-nav-menu">
						<ul role="list" class="nav-menu-two w-list-unstyled">
							...
							<li>
								<a href="#" class="nav-link">Tokoh Muda</a>
							</li>
							<li>
		...
		<div class="container">
			...
			<div class="hero-wrapper">
				<div class="hero-split">
					...
					<a href="#" class="button-primary w-button">Start Voting</a>
				</div>
				<div class="hero-split"><img src="assets/Tokoh Muda.jpg" loading="lazy" srcset="" width="100%" alt="TokohMuda" class="shadow-two"></div>
			</div>
		</div>
	</section>
	<section class="team-circles wf-section">
		<div class="container">
			<h2 class="centered-heading">Tokoh Muda Kerinci</h2>
			<div class="team-grid">
		...
		<div class="container">
			<div class="footer-wrapper-three">
				...
				<div class="footer-bottom">
					<div class="footer-copyright">@ 2022 Tokoh Muda - Voting Tokoh Muda. All right reserved</div>
					<div href="#" class="footer-legal-block">
						<a href="https://www.instagram.com/tokohmudakerinci/?hl=id" class="footer-legal-link">@tokohmudakerinci</a>
					</div>
				</div>
			</div>
		</div>
